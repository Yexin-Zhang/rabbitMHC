...
if __name__ == '__main__':
    ...
    ALLELE_INFO = os.path.join(this_dir, 'data/MHC_alleles_nonpseudo2.txt') 
 


    MAPPING_REF = {'gen': os.path.join(this_dir, 'data/mhc_reference_dna_8genes_nontrim_nonpseudo2.fasta'),
